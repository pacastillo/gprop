 ...
 public:
  ...
  TWindow( Gtk_Main &m ) :
    ...
    popKiller(0.3), evalFunc()
    {
      ...
      EOUniformCrossover< eoFloat > *xOver = 
	new  EOUniformCrossover< eoFloat >( 0.75 );
      ...
      inicial = new TCommonDialog( LIM_GENERACIONES , generacion , 
				 sizePop , numGenes , bitXgen , 
				 selectRate , 
				 OkCancel);
      connect_to_method( inicial->closed, this, &TWindow::close_config_dialog_inicial );

      prefs = new TCommonDialog( LIM_GENERACIONES , generacion , 
				 incrTamPop ,  numGenes , bitXgen ,
				 selectRate , 
				 OkCancel, false);

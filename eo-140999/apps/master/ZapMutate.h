...
//-----------------------------------------------------------------------------
/* ZapMutate.h
 Zapping operator to be used with genetic mastermind and EO
 (c) GeNeura Team, 1999
...
class ZapMutate: public MonOp<EOTchar> {
public:
	///
	ZapMutate( char _lb, char _ub, float _priority = 0):
	...
	*/
	virtual void applyAt( EOTchar& _eo, 
	  ...
	  Uniform<char> uniform(lb, ub);
	  char tmp = uniform();
	  _eo.writeGene( _i, tmp );
	}
